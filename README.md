...
The official TypeScript/Node.js client for [AgentScore](https://www.agentscore.com). Verify the human behind an agent (KYC, age, sanctions, jurisdiction) and gate payments, in a few lines.
...
| ----------- | -------- | --------------------------- | ------------------------ |
| `apiKey`    | `string` | ---                         | API key from [agentscore.com](https://www.agentscore.com) |
